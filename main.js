...
function buyAxe(){
    ...
    if(strength >= axeCost){                                   //checks that the player can afford the axe
        ...
        document.getElementById('units').innerHTML = axes;  //updates the number of axe for the user
    ...
    document.getElementById('unitCost').innerHTML = nextCost;  //updates the axe cost for the user
};
